...
public class EditVIPProfileController {
	@FXML
	...
	public EditVIPProfileController(Stage parentStage, Model model) {
		...
		editProfile.setOnAction(event ->{
			if(!username.getText().isEmpty() && !password.getText().isEmpty() && !firstName.getText().isEmpty() && !lastName.getText().isEmpty()) {
				...
				try {
					...
					model.getVIPUserDao().editProfile(user, currentUsername);
